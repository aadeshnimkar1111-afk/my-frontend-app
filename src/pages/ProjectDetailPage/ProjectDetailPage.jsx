...
function ProjectDetailPage({ id }) {
  ...
  if (!property) {
    return (
      <div className="project-overlay" onClick={close}>
        <div
          className="project-overlay__panel project-detail__not-found"
          onClick={(e) => e.stopPropagation()}
        >
          <p>This project doesn't exist.</p>
          <button onClick={close}>Go back home</button>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="project-overlay" onClick={close}>
      <div className="project-overlay__panel" onClick={(e) => e.stopPropagation()}>
        <button className="project-overlay__close" aria-label="Close" onClick={close}>
          <X size={20} />
        </button>
